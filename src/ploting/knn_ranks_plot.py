    ...
    model_specs = [
        {
            ...
            "kwargs": {
                "local_threshold": 0,
                "laplacian_parameters": {"lambda_knn": 1000},
            },
        },
        {
...
def plotting(anomaly_type: str):
    ...
    with open(f"figures/KNN_results_rank_sensitivity_{anomaly_type}.json", "r") as f:
        results = json.load(f)
...
for anomaly_type in anomaly_types:
    ...
    for spec in model_specs:
        ...
        for r in ranks_to_test:
            ...
            print(f"    Rank: {r} | Mean AUC: {mean_auc:.4f}")

    # Save inside the anomaly_type loop
    output_path = Path(f"figures/KNN_results_rank_sensitivity_{anomaly_type}.json")
